...
export default function VacantDetailScreen() {
  ...
  return (
    <ScreenContainer className="p-4">
      ...
      <View className="flex-row items-center mb-6 gap-3">
        ...
        <Text className="text-3xl font-bold text-foreground">Wolne miejsca</Text>
      </View>
      ...
      {loading ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          {projects.map((project) => {
            ...
            const totalVacant = addresses.reduce((sum, addr) => sum + addr.vacant, 0);
